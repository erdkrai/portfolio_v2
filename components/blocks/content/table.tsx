...
export default function Table({
  ...
  const renderCell = (cell: TableCell, header: TableHeader) => {
    ...
    switch (cell.type) {
      ...
      case "badge":
        // Map badge variants to valid Badge component variants
        const badgeVariantMap = {
          default: "default",
          secondary: "secondary", 
          success: "default", // Map to default since success doesn't exist
          warning: "outline", // Map to outline for warning
          destructive: "destructive",
        } as const;
        
        const mappedVariant = cell.badgeVariant ? badgeVariantMap[cell.badgeVariant] : "default";
        ...
        return (
          <Badge 
            ...
            className={cn(
              "text-xs",
              cell.badgeVariant === "success" && "bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200",
              cell.badgeVariant === "warning" && "bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200"
            )}
          >
            {content}
          </Badge>
