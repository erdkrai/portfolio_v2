...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "string",
      title: "Alignment",
      description: "Align the divider within its container (only applies when width is not full)",
      options: {
        list: [
    ...
    defineField({
      ...
      description: "Choose an icon for decorative divider style (only used when style is 'decorative')",
      options: {
        list: [
